<p style="text-align:center;color:green;font-size:24px">Thêm sản phẩm</p>
<form  class="" action="../../../fashinista/admin/index.php?act=addProduct" method="post" enctype="multipart/form-data">
...
<!--        </div>-->
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <textarea class="form-control" id="des_product" name="des_product" required="" type="text"></textarea>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input id="filebutton" name="pic1" class="input-file" type="file" required>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input id="filebutton" name="pic2" class="input-file" type="file" required>
            </div>
        </div>
        <div class="form-group">
            <label class="col-md-4 control-label" for="filebutton">Ảnh 3</label>
            <div class="col-md-4">
                <input id="filebutton" name="pic3" class="input-file" type="file" required>
            </div>
        </div>
        <div class="form-group">
            <label class="col-md-4 control-label" for="filebutton">Ảnh 4</label>
            <div class="col-md-4">
                <input id="filebutton" name="pic4" class="input-file" type="file" required>
            </div>
        </div>
