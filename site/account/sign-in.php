            ...
            <div class="md:w-8/12 lg:w-5/12 lg:ml-20">
                ...
                <form method="post" enctype="application/x-www-form-urlencoded" action="../index.php?act=signin">
                    ...
                    <div class="mb-6">
                        <label>Mật khẩu</label>
                        <input
                                type="password" name="pass_customer"
                                class="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                    ...
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <input class="inline-block px-7 py-3 bg-blue-600 text-white font-medium text-sm leading-snug uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out w-full"
                               data-mdb-ripple="true"
                                type="submit" name="signin" value="ĐĂNG NHẬP">

                    <button
                            type="submit"
                            class="inline-block px-7 py-3 bg-blue-600 text-white font-medium text-sm leading-snug uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out w-full my-3"
                            data-mdb-ripple="true"
